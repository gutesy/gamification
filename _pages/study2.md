...
Educators often face the same questions every year: How can they make students interested, make the material important to them, have fun, and help students want to learn on their own? In the last ten years, using digital media, games, and gamification (adding game-like features to non-game situations) has become popular in education. Research shows that good game design can make learning more interesting, motivating, challenging, and fun—qualities that traditional lectures often lack. Even though some people think games might not fit with higher education traditions, studies show that games in the classroom can create active learning, encourage creativity, teamwork, and help students want to learn for themselves.

Most studies about gamification have been done in marketing and business, and they often use technology to create these experiences. Research on gamification is still new, limited, and often lacks strong theories and good methods. It is also hard to apply gamification in the same way in different settings, like work or school. Meaningful gamification is different because it tries to make learning experiences important for students and connect them to real life, helping students feel motivated from within.

The Current Research
-
Adding game-like features such as stories, choices, and engagement to learning now focuses more on helping students enjoy learning for its own sake, not just for rewards. Meaningful gamification uses six elements called RECIPE: reflection, exposition, choice, information, play, and engagement. Play lets students explore freely without strict rules. Exposition adds stories to help students relate to the material. Choice lets students pick activities and goals, and information gives feedback in different ways. Engagement means connecting with others and feeling challenged. Reflection helps students find meaning in what they learn. Not all six elements are needed for meaningful gamification.

The main goal of meaningful gamification is to help students think more deeply and connect what they learn to real-life situations. This approach aims to create long-lasting change and build a community where students are motivated from within. In IO psychology courses, students study how people behave at work by using psychological theories and principles. They learn about different roles in organizations, how these roles work, and how they are connected. Teaching about organizational structure and psychological theories together also allows for the use of gamification elements like engagement, storytelling, and choice, which can help students reflect more and understand the material better.

The goal of this research is to create an IO psychology course that uses meaningful gamification and to see if this approach is more effective than traditional teaching. Specifically, the study asks if gamification can improve engagement, motivation, students’ views of their learning, and actual learning outcomes compared to regular teaching methods. To test this, the researchers used a quasi-experimental design. One group of students took the gamified course, which included role-playing and choices at different levels (individual, team, and class), while another group took a traditional course. The researchers then compared learning outcomes, engagement, motivation, and students’ perceptions of their learning between the two groups. Authors say: “We hypothesize that students in the experimental condition will have greater perceptions of learning, higher engagement in the course, higher levels of enjoyment, and perceived motivation compared to the control condition. We also hypothesize that those in the experimental condition will perform higher on learning outcome measures than in the control condition. We will also explore students’ perceptions of each teaching technique employed within the course (e.g., exams, quizzes, lecture, role-play) in comparison to the traditional course, in order to better understand which course components students perceive are most impactful to their learning.”

#Design of IO Psychology Course With Meaningful Gamification Elements
In order to control for undergraduate course differences, two IO psychology courses were designed for this study. Each course was similar in regard to course instruction (e.g., same instructor); assignments; learning objectives; goals; and content of class activities, quizzes, exams, and projects. The experimental course was designed with an overlay of meaningful gamification elements integrated into the course structure (e.g., syllabus, activities). The organization profiled for this project was a national publicly held bank that provides retail and commercial baking products and services primarily on the east coast.

Traditional courses
-
In traditional courses, students received a standard syllabus with course details, objectives, and a regular grading system. They were randomly placed into teams and given one of five realistic organizational problems to solve, acting as external I/O psychology consultants for a national bank. The problems included issues like personnel, customer service, and work processes. Teams used textbooks, class notes, and research databases to develop solutions. Extra credit was available through research participation and other standard assignments.
...
The ANCOVA on perceived experience revealed a significant condition main effect, F(1, 90) = 4.98, p < .05, η2 = .05. Participants in the experimental condition rated their perceived experience more positively (M = 4.31, SD = 0.42) than those in the control condition (M = 4.12, SD = 0.37), with controlling for time of class. Neither the time main effect nor the Condition × Time interaction approached significance. Post hoc analysis revealed that participants in the experimental condition rated the course significantly more enjoyable, motivating, engaging, and fun than in the control condition.

Perceived learning
-
The ANCOVA on perceived learning revealed a significant condition main effect, F(1, 90) = 11.58, p < .01, η2 = .11. Participants in the experimental condition revealed higher perceptions of learning (M = 4.34, SD = 0.46) than those in the control condition (M = 4.06, SD = 0.41), with controlling for time of class. Neither the time main effect nor the Condition × Time interaction approached significance, though time of class did approach significance, p = .052. Post hoc analysis revealed that participants in the experimental condition perceptions of learning were significantly higher than those in the control condition on all individual variables.
...
Analysis of the entire 19-item scale (α = .95) showed students reported favorable perceptions on average on all individual items. In regard to perceptions of skills learned via games, collaboration and teamwork were reported as the top skill (87.5%) that games provide. In all, 83.3% of students checked creativity and problem-solving, 79.2% checked critical thinking and leading/motivating, and 58.3% selected analyzing/classifying as the skills games provide. Interestingly, only 5.9% preferred a competitive learning style, while 47.1% preferred a cooperative learning style, which defines learning by working with other students, and 47.1% of students reported an individual learning style.

What to take home?
-
Content Knowledge There was no significant difference in quiz scores between the experimental and control groups. Both groups performed similarly on content knowledge tests throughout the semester.
Perceived Experience Students in the gamified course rated their overall experience more positively than those in the traditional course. They found the course more enjoyable, motivating, engaging, and fun.
Perceived Learning Students in the gamified course also reported higher perceptions of their own learning compared to the traditional group. 
Perceived Impact of Teaching Techniques Students in the gamified course felt that group activities and team projects had a greater impact on their learning than students in the traditional. Students in the gamified course rated role-playing, and they reported it had a high impact on their learning. There were no significant differences between groups for other teaching techniques.
Summative Perceptions Students in the gamified course had generally positive views about their experience. They identified collaboration and teamwork as the top skills learned through games, followed by creativity, problem-solving, critical thinking, and leadership. Most students preferred cooperative (47.1%) or individual (47.1%) learning styles, with very few (5.9%) preferring a competitive style.

DISCUSSION
-
The results show that using meaningful gamification in the classroom, such as role-playing and play, leads to higher student engagement, motivation, and perceived learning compared to traditional teaching methods. Students in the gamified course felt more involved and thought group activities and team projects helped them learn more. However, the study did not find that students in the gamified course had higher actual learning outcomes (quiz scores) than those in the traditional course. This means that gamification is just as effective as traditional methods for learning content, but it makes students feel more positive about their learning experience.
Students in the gamified course reported that the course design helped them understand the material better, increased their confidence, kept them involved, reinforced key concepts, improved their reasoning, and helped them apply what they learned. They also felt more motivated to learn and recommended using these activities in other courses. Many said they would take more courses with role-playing techniques.
Some teachers may worry that gamification requires special technology, but this research shows that meaningful gamification can be added without advanced tech skills. For example, teachers can use narrative and role-play in many psychology courses by assigning students to act as different types of psychologists or theories. This helps students connect more deeply with the material, encourages diversity and open-mindedness, and improves motivation, engagement, critical thinking, and teamwork. These gamification elements can be easily included in course objectives and syllabi across psychology courses.

CONCLUSION
-
In conclusion, this research shows that adding meaningful gamification elements like play, narrative, and choice to psychology courses increases students’ enjoyment, engagement, and motivation compared to traditional teaching methods. Understanding how students feel about their learning is important for designing effective instruction and boosting their motivation. A positive learning environment can help students feel more confident and passionate about learning.
However, more research is needed to find out how each gamification element affects students’ perceptions and whether these elements can lead to long-term learning. For example, creating a strong story and clear rules, and encouraging teamwork, may help students feel more motivated and invested in their studies. It is also important to consider individual differences in how students respond to gamification. As teaching methods evolve, we should remember the value of simple learning principles like play.
