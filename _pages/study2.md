...
The study took place on the campus of a large metropolitan university during the course of 1 academic year. In two different sections of an I/O psychology course taught by the same professor 3 times a week for 50 min each semester, 99 undergraduate psychology students participated.

Measures and Procedures 
-

To track the effectiveness of the course, researchers used three main tools to measure student progress and feelings. First, students took six identical quizzes throughout the semester to test their actual knowledge of the material, using a mix of multiple-choice and short-answer questions. Second, twelve surveys were given during the term to see how students felt about the class activities and how much they thought they were learning at that specific moment. Finally, at the end of the year, the gamified group completed a detailed survey to describe their overall experience.

Results
-

The data were analyzed using a mixed design 2 (condition: experimental vs. control) × 3(time: beginning, middle, end) analysis of covariance (ANCOVA) controlling for time of class. Researchers looked at three main areas: actual knowledge, how students felt about the class, and how much they thought they were learning 

Results showed that actual academic performance was equal between the two groups; students in the gamified section scored just as well on content quizzes as those in the traditional section. 
...
The results show that gamification is just as effective as traditional methods for learning content, but it makes students feel more positive about their learning experience.
...
Some teachers may worry that gamification requires special technology, but this research shows that meaningful gamification can be added without advanced tech skills. For example, teachers can use narrative and role-play in many psychology courses by assigning students to act as different types of psychologists or theories.

However, more research is needed to find out how each gamification element affects students’ perceptions and whether these elements can lead to long-term learning. It is also important to consider individual differences in how students respond to gamification.
